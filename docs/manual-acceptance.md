...
- [x] Deleted files and write failures produce non-destructive notices. PASS 2026-07-18: moving `test-project.md` outside the vault after menu open and separately removing write permission from both file and parent directory prevented the stale selections; the restored file retained SHA-256 `ae14fd69f03b5e334c873238a8443bbfbd396c563b241162c53683437f0a98bf`.
